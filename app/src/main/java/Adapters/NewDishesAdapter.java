...
import com.project.tofy.R;

import Helpers.DatabaseHelper;
import Models.Food;

public class NewDishesAdapter extends FirestoreRecyclerAdapter<Food,NewDishesAdapter.FoodViewHolder> {
    private OnNewDishItemClick onNewDishItemClick;
    public DatabaseHelper dbHelper;

    public NewDishesAdapter(@NonNull FirestoreRecyclerOptions<Food> options, OnNewDishItemClick onNewDishItemClick, Context context) {
        super(options);
        this.onNewDishItemClick = onNewDishItemClick;
    ...
    public FoodViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view= LayoutInflater.from(parent.getContext()).inflate(R.layout.newdish_template,parent,false);
    ...
    public class FoodViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            onNewDishItemClick.onDishItemclick(getItem(getAdapterPosition()), getAdapterPosition());
        }
    }
    public interface OnNewDishItemClick {
        void onDishItemclick(Food foodItem, int position);
    }
}
